...
namespace FootballManager.Infrastructure.Migrations
{
    ...
    [Migration("20260827152920_Advertisements")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FootballManager.Domain.Entities.Advertisement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("LeagueId", "Slot");

                    b.ToTable("advertisements", null, t =>
                        {
                            t.HasCheckConstraint("CK_advertisements_ends_at_gte_starts_at", "ends_at IS NULL OR starts_at IS NULL OR ends_at >= starts_at");
                        });
                });
            ...
            modelBuilder.Entity("FootballManager.Domain.Entities.DivisionMatchRules", b =>
                {
                    ...
                    b.ToTable("division_match_rules", (string)null);
                });
            ...
            modelBuilder.Entity("FootballManager.Domain.Entities.DivisionSeasonField", b =>
                {
                    b.Property<Guid>("DivisionSeasonId")
                        .HasColumnType("uuid")
                        .HasColumnName("division_season_id");
                    ...
                    b.HasKey("DivisionSeasonId", "FieldId");

                    b.HasIndex("FieldId");

                    b.ToTable("division_season_fields", (string)null);
                });
            ...
            modelBuilder.Entity("FootballManager.Domain.Entities.LeagueDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("LeagueId", "CategoryId", "SortOrder");

                    b.ToTable("league_documents", (string)null);
                });

            modelBuilder.Entity("FootballManager.Domain.Entities.LeagueDocumentCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("RequiresDocumentDate")
                        .HasColumnType("boolean")
                        .HasColumnName("requires_document_date");
                    ...
                    b.ToTable("league_document_categories", (string)null);
                });
            ...
            modelBuilder.Entity("FootballManager.Domain.Entities.MatchIncident", b =>
                {
                    ...
                    b.ToTable("match_incidents", (string)null);
                });
            ...
            modelBuilder.Entity("FootballManager.Domain.Entities.LeagueDocument", b =>
                {
                    b.HasOne("FootballManager.Domain.Entities.LeagueDocumentCategory", "Category")
                        .WithMany()
