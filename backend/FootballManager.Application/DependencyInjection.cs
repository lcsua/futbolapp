...
namespace FootballManager.Application
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddApplication(this IServiceCollection services)
        {
            ...
            services.AddScoped<IDeleteDivisionUseCase, DeleteDivisionUseCase>();
            ...
            services.AddScoped<IGetSeasonSetupUseCase, GetSeasonSetupUseCase>();
            services.AddScoped<ISaveSeasonSetupUseCase, SaveSeasonSetupUseCase>();
            services.AddScoped<ICopySeasonFromUseCase, CopySeasonFromUseCase>();
